...
<div class="wrap fs-section wpaicg-image-generator<?php echo isset($wpaicg_image_shortcode) && $wpaicg_image_shortcode ? ' wpaicg-image-shortcode':''?>">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="<?php echo esc_url($wpaicg_dalle_url)?>" class="nav-tab<?php echo empty($wpaicg_action) ? ' nav-tab-active' : ''?>">DALL-E</a>
        <a href="<?php echo esc_url($wpaicg_sd_url)?>" class="nav-tab<?php echo $wpaicg_action == 'stable-diffusion' ? ' nav-tab-active' : ''?>">Stable Diffusion</a>
